...
# file_p = File("./Output/patch_test/nx_10/Upwind+FL+SL/pres.pvd")
# file_s_FL_SL = File("./Output/patch_test/nx_10/Upwind+FL+SL/sat.pvd")
# file_error = File("./Output/patch_test/nx_%d/Upwind/error.pvd"%nx)
...
for nIter in range(num_steps):
    ...
    # print('FLUX',FLUX)
    error_val = 0.2 *  sAvg.vector().array() - 0.2 * sAvg0.vector().array() +\
    ...
    error.rename("Local mass balance error","error")
    # print('flux_limiter ConvergeItr',convergedIter)
